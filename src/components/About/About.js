                  ...
                  <div className="flex flex-col sm:flex-row gap-6">
                    ...
                    <div className="space-y-2 text-white">
                      ...
                      <p className="text-md text-white/70 text-justify">
                        I specialize in developing responsive, user-friendly web applications using the MERN stack, with a strong focus on both functionality and user experience. I build scalable backends and design clean, visually engaging interfaces. While the MERN stack is my main focus, I'm also comfortable working with other technologies when needed.
                      </p>
                    </div>
                  </div>
                </section>
